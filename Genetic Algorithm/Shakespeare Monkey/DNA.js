...
function newChar() {
  var c = floor(random(63,123));  //random(initial,final-1)
  if (c === 63) c = 32;
  if (c === 64) c = 46;
  if (c >90 && c<97) c = floor(random(97,123)); //only alphabats
...
function DNA(num) {
  ...
  this.calcFitness = function(target) {
     ...
     this.fitness = pow(score / target.length,4); //+0.01; hack (creats error)
  }
